...
\markright{ENSIIE 1A 2016 - Michel Massaro\\ Alexis Schutzger - Franck Schmitt}
...
\begin{center}
\includegraphics[scale=0.5]{firstEq.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{secEq.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.5]{adapt.png}
\end{center}
